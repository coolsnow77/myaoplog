package com.xueguoxue.aoplog.config;

import com.xueguoxue.aoplog.domain.Action;
import com.xueguoxue.aoplog.domain.ActionType;
import com.xueguoxue.aoplog.domain.ChangeItem;
import com.xueguoxue.aoplog.utils.DiffUtil;
import com.xueguoxue.aoplog.dao.ActionDao;
...
public class DatalogAspect {
    ...
    @Pointcut("execution(public * com.xueguoxue.aoplog.dao.*.save*(..))")
    public void save(){

    }

    @Pointcut("execution(public * com.xueguoxue.aoplog.dao.*.delete*(..))")
    public void delete(){
